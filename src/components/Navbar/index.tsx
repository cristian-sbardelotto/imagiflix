    ...
    <nav className='navbar absolute top-0 left-0 p-8 grid grid-cols-2 w-full z-20'>
      ...
      <div className='flex gap-6 items-center justify-self-end'>
        <form className='flex relative w-64'>
          <input
            className='w-full bg-black border border-white outline-none rounded px-3 py-1 transition-all duration-300 ease-in-out opacity-0 hover:opacity-100 focus:opacity-100'
            type='text'
          ...
          />
          <button
            className='absolute right-3 py-1'
        ...
        <div className='relative flex gap-2'>
          ...
          <ul
            className={`absolute right-0 top-10 w-40 bg-black rounded pl-4 py-3 transition-all duration-300 ease-in-out ${
              !isMenuOpen && 'invisible opacity-0'
            }`}
          >
            <li>
              <a href='#account' onClick={handleUserClick}>
                Minha conta
              </a>
            </li>
            <li>
              <a href='#logout' onClick={handleUserClick}>
                Sair
              </a>
            </li>
          </ul>
